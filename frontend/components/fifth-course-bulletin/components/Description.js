    ...
    <View style={{ marginTop: '30px' }}>
      ...
      <View style={{ marginTop: '10px' }}>
        <Text style={stylesDescription.text_center}>
          ...
          jornada
          <Text>{` ${GRADES[course].time}`}</Text> en concordancia con los fines y objetivos de la Ley 115 de 1.994, los
          Decretos 1290 del 16 de abril de 2009 y los criterios de evaluación y promociones del SIEE ( Sistema

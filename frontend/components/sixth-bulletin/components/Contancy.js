    ...
    <View style={stylescontancy.container}>
      ...
      <View style={stylescontancy.container_sing}>
        ...
        <View style={stylescontancy.subcontainer_sing}>
          ...
          <View style={stylescontancy.column_sing}>
            <Text style={stylescontancy.text_sing}>Auxiliar Administrativo</Text>
          </View>
        </View>
      </View>
      <Text style={stylescontancy.text_note}>
        NOTA: El presente documento no requiere de sellos ni autenticaciones de firmas, segun decreto 2150 de diciembre
        5 de 1995
      </Text>
    </View>
  )
